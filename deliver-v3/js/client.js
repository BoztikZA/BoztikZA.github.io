...
/*
  ...
  the admin may be signed in from another tab while a
...
function triggerFileSave(
  ...
  /*
    ...
    the signed Worker URL as a download.
  ...
  */
  ...
  try {
    ...
    */
    ...
    /*
      Do not expose raw server/database errors to
      the client.
  ...
  try {
    ...
    */
    ...
    if (
      ...
      /*
        The Worker decides: preview=1 only suppresses counting
        when the request also carries a valid admin session.
      */
      recordView(
        delivery.id,
